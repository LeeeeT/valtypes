...
__all__ = ["iterable_to_typed_list"]
...
@convert
def iterable_to_typed_list(target_type: type[T_list], source: Iterable[object], collection: Collection) -> T_list:
    values_type = resolve_type_args(target_type, list)[0]
    try:
